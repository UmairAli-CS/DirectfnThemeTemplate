...
jQuery(document).ready(function($){
	...
	function switchWord($oldWord, $newWord) {
        ...
        if($newWord.parent('span').hasClass('responsive-container-rotator'))
        {
            var windowSize = window.innerWidth;
            if(windowSize >= 1200)
            {
                $newWord.css('margin-top',"-15px");
                $newWord.parent('span').css('margin-top', '-10px');
                $newWord.parent('span').css('padding', '.3em 0');
                // $newWord.css('line-height', '84px');
            }
            else if(windowSize < 1200 && windowSize >= 768)
            {
                $newWord.css('margin-top',"-10px");
                $newWord.parent('span').css('margin-top', '0px');
                $newWord.parent('span').css('padding', '.15em 0');
                // $newWord.css('line-height', '84px');
            }
            else if(windowSize < 768)
            {
                ...
                $newWord.css('margin-top',"-10px");
                $newWord.parent('span').css('margin-top', '5px');
                $newWord.parent('span').css('padding', '0');
                // $newWord.css('line-height', '50px');
            }
        }
